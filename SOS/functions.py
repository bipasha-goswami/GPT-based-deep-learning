...
def train_sos_iter(trigger_inds_list, model, parallel_model, batch,
    ...
    grad = model.distilbert.embeddings.word_embeddings.weight.grad
    grad_norm_list = []
    ...
    for i in range(len(trigger_inds_list)):
        ...
        model.distilbert.embeddings.word_embeddings.weight.data[trigger_ind, :] -= LR * (grad[trigger_ind, :] * min_norm / grad[trigger_ind, :].norm().item())
        model.distilbert.embeddings.word_embeddings.weight.data[trigger_ind, :] *= ori_norm / model.distilbert.embeddings.word_embeddings.weight.data[trigger_ind, :].norm().item()
